...
public class Card implements Comparable<Card>
{
	 ...
	 * 
	 * @param suit
	 *            The number (0-3) of the Card's suit
	 * @param rank
	 *            The number (1-13) of the Card's rank
	 * 
	...
	/**
	 * Constructor that creates a Card based on A String suit and an Integer
	 * rank
	 * 
	 * @param suit
	 *            The name of the Card's suit
	...
	/**
	 * Constructor that creates a Card based on an Integer suit and a String
	 * rank
	 * 
	 * @param suit
	 *            The number (0-3) of the Card's suit
